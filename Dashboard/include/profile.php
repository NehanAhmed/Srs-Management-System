						...
						<div class="col-md-4 col-xl-3">
							<div class="card mb-3">
								...
								<div class="card-body text-center">
									<img src="<?php  echo $_SESSION['profileImg']?>" alt="Christina Mason" class="img-fluid rounded-circle mb-2" width="128" height="128" />
									<h5 class="card-title mb-0 fs-5">
										<?php echo $_SESSION['name']?>
									</h5>
									<div class="text-muted mb-2"><?php if (isset($_SESSION['RoleID'])) {
		...
		?></div>
								...
								<div class="card-body">
									...
									<ul class="list-unstyled mb-0">
										<li class="mb-1"><a href="#"><?php echo $_SESSION['Email']?></a></li>
