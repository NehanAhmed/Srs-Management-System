<nav id="sidebar" class="sidebar js-sidebar">
	<div class="sidebar-content js-simplebar" data-simplebar="init">
							...
							<ul class="sidebar-nav">
								...
								<li class="sidebar-item">
									<a class="sidebar-link" href="../Dashboard/index.php?profile">
										...
										</svg> <span cl`ass="align-middle">Profile</span>
									</a>
								</li>
								...
								<li class="sidebar-item">
									<a class="sidebar-link" href="../Dashboard/index.php?all-products">
										...
										</svg> <span class="align-middle">All Products</span>
									</a>
								</li>
								...
								<li class="sidebar-item">
									<a class="sidebar-link" href="../Dashboard/index.php?marketplace">
										...
										</svg><span class="align-middle">Marketplace</span>
									</a>
								</li>

								<li class="sidebar-item">
									<a class="sidebar-link" href="../Dashboard/index.php?workflow">
										<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-shopping-bag align-middle me-2">
											<path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"></path>
											<line x1="3" y1="6" x2="21" y2="6"></line>
											<path d="M16 10a4 4 0 0 1-8 0"></path>
		...
		<div class="simplebar-track simplebar-vertical" style="visibility: visible;">
			<div class="simplebar-scrollbar" style="height: 521px; transform: translate3d(0px, 0px, 0px); display: block;"></div>
		</div>
	</div>
</nav>